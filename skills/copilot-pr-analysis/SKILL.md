...
description: "Analyze Copilot coding agent PR sessions to correlate resources and MCP tools with PR outcomes (merged vs abandoned). Use for PR success factors and Copilot adoption insights."
---
