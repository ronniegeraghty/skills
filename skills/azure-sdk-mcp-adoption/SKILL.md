...
description: "Generate adoption reports correlating Azure SDK MCP tool usage with monthly SDK releases. Use for MCP adoption metrics and SDK tool usage analysis."
---
